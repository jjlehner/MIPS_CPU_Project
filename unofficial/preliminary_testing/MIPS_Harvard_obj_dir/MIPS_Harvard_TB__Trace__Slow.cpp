...
void MIPS_Harvard_TB::traceInitThis__1(MIPS_Harvard_TB__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBus(c+329,"mips_cpu program_counter_prime", false,-1, 31,0);
        ...
        vcdp->declBit(c+361,"mips_cpu program_counter_source_decode", false,-1);
        ...
        vcdp->declBit(c+337,"mips_cpu equal_decode", false,-1);
        vcdp->declBus(c+73,"mips_cpu ALU_function_decode", false,-1, 5,0);
        vcdp->declBus(c+81,"mips_cpu program_counter_branch_decode", false,-1, 31,0);
        ...
        vcdp->declBus(c+89,"mips_cpu shifter_output_decode", false,-1, 31,0);
        ...
        vcdp->declBus(c+345,"mips_cpu register_file_output_A_resolved_decode", false,-1, 31,0);
        vcdp->declBus(c+353,"mips_cpu register_file_output_B_resolved_decode", false,-1, 31,0);
        vcdp->declBus(c+97,"mips_cpu sign_imm_decode", false,-1, 31,0);
        ...
        vcdp->declBus(c+105,"mips_cpu write_register_execute", false,-1, 4,0);
        ...
        vcdp->declBus(c+113,"mips_cpu source_A_ALU_execute", false,-1, 31,0);
        vcdp->declBus(c+121,"mips_cpu source_B_ALU_execute", false,-1, 31,0);
        vcdp->declBus(c+129,"mips_cpu write_data_execute", false,-1, 31,0);
        vcdp->declBus(c+137,"mips_cpu ALU_output_execute", false,-1, 31,0);
        vcdp->declBus(c+145,"mips_cpu ALU_HI_output_execute", false,-1, 31,0);
        vcdp->declBus(c+153,"mips_cpu ALU_LO_output_execute", false,-1, 31,0);
        ...
        vcdp->declBus(c+161,"mips_cpu result_writeback", false,-1, 31,0);
        ...
        vcdp->declBit(c+169,"mips_cpu stall_fetch", false,-1);
        vcdp->declBit(c+177,"mips_cpu stall_decode", false,-1);
        vcdp->declBit(c+689,"mips_cpu forward_A_decode", false,-1);
        vcdp->declBit(c+697,"mips_cpu forward_B_decode", false,-1);
        vcdp->declBit(c+185,"mips_cpu flush_execute_register", false,-1);
        vcdp->declBus(c+193,"mips_cpu forward_A_execute", false,-1, 1,0);
        vcdp->declBus(c+201,"mips_cpu forward_B_execute", false,-1, 1,0);
        ...
        vcdp->declBus(c+161,"mips_cpu register_file write_data", false,-1, 31,0);
        ...
        vcdp->declBus(c+329,"mips_cpu pc address_input", false,-1, 31,0);
        vcdp->declBit(c+169,"mips_cpu pc enable", false,-1);
        ...
        vcdp->declBit(c+361,"mips_cpu program_counter_multiplexer control", false,-1);
        vcdp->declBus(c+393,"mips_cpu program_counter_multiplexer input_0", false,-1, 31,0);
        vcdp->declBus(c+81,"mips_cpu program_counter_multiplexer input_1", false,-1, 31,0);
        vcdp->declBus(c+329,"mips_cpu program_counter_multiplexer resolved", false,-1, 31,0);
        vcdp->declBit(c+1,"mips_cpu fetch_decode_register clk", false,-1);
        vcdp->declBit(c+177,"mips_cpu fetch_decode_register enable", false,-1);
        vcdp->declBit(c+361,"mips_cpu fetch_decode_register clear", false,-1);
        ...
        vcdp->declBus(c+209,"mips_cpu control_unit op", false,-1, 5,0);
        vcdp->declBus(c+425,"mips_cpu control_unit rt", false,-1, 4,0);
        vcdp->declBus(c+217,"mips_cpu control_unit funct", false,-1, 5,0);
        ...
        vcdp->declBus(c+345,"mips_cpu register_file_output_A_mux resolved", false,-1, 31,0);
        ...
        vcdp->declBus(c+353,"mips_cpu register_file_output_B_mux resolved", false,-1, 31,0);
        vcdp->declBus(c+345,"mips_cpu reg_output_comparator a", false,-1, 31,0);
        vcdp->declBus(c+353,"mips_cpu reg_output_comparator b", false,-1, 31,0);
        vcdp->declBit(c+337,"mips_cpu reg_output_comparator c", false,-1);
        vcdp->declBit(c+57,"mips_cpu program_counter_source_and_gate_decode input_A", false,-1);
        vcdp->declBit(c+337,"mips_cpu program_counter_source_and_gate_decode input_B", false,-1);
        vcdp->declBit(c+361,"mips_cpu program_counter_source_and_gate_decode output_C", false,-1);
        vcdp->declBus(c+441,"mips_cpu sign_extender_decode short_input", false,-1, 15,0);
        vcdp->declBus(c+97,"mips_cpu sign_extender_decode extended_output", false,-1, 31,0);
        vcdp->declBus(c+1121,"mips_cpu shifter_decode shift_distance", false,-1, 31,0);
        vcdp->declBus(c+97,"mips_cpu shifter_decode shift_input", false,-1, 31,0);
        vcdp->declBus(c+89,"mips_cpu shifter_decode shift_output", false,-1, 31,0);
        vcdp->declBus(c+89,"mips_cpu adder_decode a", false,-1, 31,0);
        vcdp->declBus(c+409,"mips_cpu adder_decode b", false,-1, 31,0);
        vcdp->declBus(c+81,"mips_cpu adder_decode z", false,-1, 31,0);
        vcdp->declBit(c+1,"mips_cpu decode_execute_register clk", false,-1);
        vcdp->declBit(c+185,"mips_cpu decode_execute_register clear", false,-1);
        ...
        vcdp->declBus(c+97,"mips_cpu decode_execute_register sign_imm_decode", false,-1, 31,0);
        ...
        vcdp->declBus(c+105,"mips_cpu write_register_execute_mux resolved", false,-1, 4,0);
        vcdp->declBus(c+1113,"mips_cpu register_file_output_A_execute_mux BUS_WIDTH", false,-1, 31,0);
        vcdp->declBus(c+193,"mips_cpu register_file_output_A_execute_mux control", false,-1, 1,0);
        vcdp->declBus(c+505,"mips_cpu register_file_output_A_execute_mux input_0", false,-1, 31,0);
        vcdp->declBus(c+161,"mips_cpu register_file_output_A_execute_mux input_1", false,-1, 31,0);
        ...
        vcdp->declBus(c+113,"mips_cpu register_file_output_A_execute_mux resolved", false,-1, 31,0);
        vcdp->declBus(c+1113,"mips_cpu register_file_output_B_execute_mux BUS_WIDTH", false,-1, 31,0);
        vcdp->declBus(c+201,"mips_cpu register_file_output_B_execute_mux control", false,-1, 1,0);
        vcdp->declBus(c+513,"mips_cpu register_file_output_B_execute_mux input_0", false,-1, 31,0);
        vcdp->declBus(c+161,"mips_cpu register_file_output_B_execute_mux input_1", false,-1, 31,0);
        ...
        vcdp->declBus(c+129,"mips_cpu register_file_output_B_execute_mux resolved", false,-1, 31,0);
        ...
        vcdp->declBus(c+129,"mips_cpu source_B_ALU_mux input_0", false,-1, 31,0);
        vcdp->declBus(c+545,"mips_cpu source_B_ALU_mux input_1", false,-1, 31,0);
        vcdp->declBus(c+121,"mips_cpu source_B_ALU_mux resolved", false,-1, 31,0);
        vcdp->declBus(c+481,"mips_cpu alu ALU_operation", false,-1, 5,0);
        vcdp->declBus(c+113,"mips_cpu alu input_1", false,-1, 31,0);
        vcdp->declBus(c+121,"mips_cpu alu input_2", false,-1, 31,0);
        vcdp->declBus(c+137,"mips_cpu alu ALU_output", false,-1, 31,0);
        vcdp->declBus(c+145,"mips_cpu alu ALU_HI_output", false,-1, 31,0);
        vcdp->declBus(c+153,"mips_cpu alu ALU_LO_output", false,-1, 31,0);
        vcdp->declBus(c+225,"mips_cpu alu shift_amount", false,-1, 4,0);
        vcdp->declQuad(c+233,"mips_cpu alu sign_extened_input_1", false,-1, 63,0);
        vcdp->declQuad(c+249,"mips_cpu alu sign_extened_input_2", false,-1, 63,0);
        vcdp->declQuad(c+265,"mips_cpu alu extended_input_1", false,-1, 63,0);
        vcdp->declQuad(c+281,"mips_cpu alu extended_input_2", false,-1, 63,0);
        vcdp->declQuad(c+297,"mips_cpu alu ALU_HI_LO_output", false,-1, 63,0);
        ...
        vcdp->declBus(c+137,"mips_cpu execute_memory_register ALU_output_execute", false,-1, 31,0);
        vcdp->declBus(c+145,"mips_cpu execute_memory_register ALU_HI_output_execute", false,-1, 31,0);
        vcdp->declBus(c+153,"mips_cpu execute_memory_register ALU_LO_output_execute", false,-1, 31,0);
        vcdp->declBus(c+129,"mips_cpu execute_memory_register write_data_execute", false,-1, 31,0);
        vcdp->declBus(c+105,"mips_cpu execute_memory_register write_register_execute", false,-1, 4,0);
        ...
        vcdp->declBus(c+673,"mips_cpu writeback_mux input_0", false,-1, 31,0);
        vcdp->declBus(c+681,"mips_cpu writeback_mux input_1", false,-1, 31,0);
        vcdp->declBus(c+161,"mips_cpu writeback_mux resolved", false,-1, 31,0);
        ...
        vcdp->declBus(c+105,"mips_cpu hazard_unit write_register_execute", false,-1, 4,0);
        ...
        vcdp->declBit(c+169,"mips_cpu hazard_unit stall_fetch", false,-1);
        vcdp->declBit(c+177,"mips_cpu hazard_unit stall_decode", false,-1);
        ...
        vcdp->declBit(c+185,"mips_cpu hazard_unit flush_execute_register", false,-1);
        vcdp->declBus(c+193,"mips_cpu hazard_unit forward_register_file_output_1_execute", false,-1, 1,0);
        vcdp->declBus(c+201,"mips_cpu hazard_unit forward_register_file_output_2_execute", false,-1, 1,0);
        vcdp->declBit(c+313,"mips_cpu hazard_unit lwstall", false,-1);
        vcdp->declBit(c+321,"mips_cpu hazard_unit branchstall", false,-1);
    }
}
...
void MIPS_Harvard_TB::traceFullThis__1(MIPS_Harvard_TB__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+81,(((vlTOPp->mips_cpu__DOT__sign_imm_decode 
                              << 2U) + vlTOPp->mips_cpu__DOT__program_counter_plus_four_decode)),32);
        vcdp->fullBus(c+89,((vlTOPp->mips_cpu__DOT__sign_imm_decode 
                             << 2U)),32);
        vcdp->fullBus(c+97,(vlTOPp->mips_cpu__DOT__sign_imm_decode),32);
        vcdp->fullBus(c+105,(vlTOPp->mips_cpu__DOT__write_register_execute),5);
        vcdp->fullBus(c+113,(vlTOPp->mips_cpu__DOT__source_A_ALU_execute),32);
        vcdp->fullBus(c+121,(vlTOPp->mips_cpu__DOT__source_B_ALU_execute),32);
        vcdp->fullBus(c+129,(vlTOPp->mips_cpu__DOT__write_data_execute),32);
        vcdp->fullBus(c+137,(vlTOPp->mips_cpu__DOT__ALU_output_execute),32);
        vcdp->fullBus(c+145,(vlTOPp->mips_cpu__DOT__ALU_HI_output_execute),32);
        vcdp->fullBus(c+153,(vlTOPp->mips_cpu__DOT__ALU_LO_output_execute),32);
        vcdp->fullBus(c+161,(vlTOPp->mips_cpu__DOT__result_writeback),32);
        vcdp->fullBit(c+169,(vlTOPp->mips_cpu__DOT__stall_fetch));
        vcdp->fullBit(c+177,(vlTOPp->mips_cpu__DOT__stall_decode));
        vcdp->fullBit(c+185,(vlTOPp->mips_cpu__DOT__flush_execute_register));
        vcdp->fullBus(c+193,(vlTOPp->mips_cpu__DOT__forward_A_execute),2);
        vcdp->fullBus(c+201,(vlTOPp->mips_cpu__DOT__forward_B_execute),2);
        vcdp->fullBus(c+209,(vlTOPp->mips_cpu__DOT__control_unit__DOT__op),6);
        vcdp->fullBus(c+217,(vlTOPp->mips_cpu__DOT__control_unit__DOT__funct),6);
        vcdp->fullBus(c+225,((0x1fU & (vlTOPp->mips_cpu__DOT__source_A_ALU_execute 
                                       >> 6U))),5);
        ...
        vcdp->fullQuad(c+249,((((QData)((IData)(VL_NEGATE_I((IData)(
                                                                    (1U 
                                                                     & (vlTOPp->mips_cpu__DOT__source_B_ALU_execute 
                                                                        >> 0x1fU)))))) 
                                << 0x20U) | (QData)((IData)(vlTOPp->mips_cpu__DOT__source_B_ALU_execute)))),64);
        vcdp->fullQuad(c+265,((QData)((IData)(vlTOPp->mips_cpu__DOT__source_A_ALU_execute))),64);
        vcdp->fullQuad(c+281,((QData)((IData)(vlTOPp->mips_cpu__DOT__source_B_ALU_execute))),64);
        vcdp->fullQuad(c+297,(vlTOPp->mips_cpu__DOT__alu__DOT__ALU_HI_LO_output),64);
        vcdp->fullBit(c+313,(vlTOPp->mips_cpu__DOT__hazard_unit__DOT__lwstall));
        vcdp->fullBit(c+321,(vlTOPp->mips_cpu__DOT__hazard_unit__DOT__branchstall));
        vcdp->fullBus(c+329,(((IData)(vlTOPp->mips_cpu__DOT__program_counter_source_decode)
        ...
        vcdp->fullBit(c+337,((((((0U != (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                  >> 0x15U))) 
        ...
        vcdp->fullBus(c+345,(((((0U != (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                 >> 0x15U))) 
                                & ((0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                             >> 0x15U)) 
                                   == (IData)(vlTOPp->mips_cpu__DOT__write_register_memory))) 
        ...
        vcdp->fullBus(c+353,(((((0U != (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                 >> 0x10U))) 
                                & ((0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                             >> 0x10U)) 
                                   == (IData)(vlTOPp->mips_cpu__DOT__write_register_memory))) 
        ...
        vcdp->fullBit(c+361,(vlTOPp->mips_cpu__DOT__program_counter_source_decode));
        ...
        vcdp->fullBus(c+393,(((IData)(4U) + vlTOPp->mips_cpu__DOT__program_counter_fetch)),32);
