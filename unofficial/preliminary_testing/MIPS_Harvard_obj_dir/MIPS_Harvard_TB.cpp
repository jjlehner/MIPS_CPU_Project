...
VL_INLINE_OPT void MIPS_Harvard_TB::_combo__TOP__1(MIPS_Harvard_TB__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    MIPS_Harvard_TB::_combo__TOP__1\n"); );
    MIPS_Harvard_TB* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void MIPS_Harvard_TB::_settle__TOP__2(MIPS_Harvard_TB__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->register_v0 = vlTOPp->mips_cpu__DOT__register_file__DOT__registers
        [2U];
    ...
    vlTOPp->data_read = vlTOPp->mips_cpu__DOT__memory_to_register_memory;
    vlTOPp->instr_address = vlTOPp->mips_cpu__DOT__program_counter_fetch;
    vlTOPp->active = (0U != vlTOPp->mips_cpu__DOT__program_counter_fetch);
                ...
                if ((4U & (IData)(vlTOPp->mips_cpu__DOT__control_unit__DOT__op))) {
                    if ((2U & (IData)(vlTOPp->mips_cpu__DOT__control_unit__DOT__op))) {
                        if ((1U & (IData)(vlTOPp->mips_cpu__DOT__control_unit__DOT__op))) {
                            ...
                            vlTOPp->mips_cpu__DOT__ALU_src_B_decode = 0U;
                            vlTOPp->mips_cpu__DOT__register_destination_decode = 0U;
                            vlTOPp->mips_cpu__DOT__branch_decode = 1U;
                            vlTOPp->mips_cpu__DOT__hi_lo_register_write_decode = 0U;
                            vlTOPp->mips_cpu__DOT__ALU_function_decode = 0x3fU;
                            vlTOPp->mips_cpu__DOT__program_counter_multiplexer_jump_decode = 0U;
                        } else {
    ...
    vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode 
        = ((((0U != (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                              >> 0x15U))) & ((0x1fU 
                                              & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                 >> 0x15U)) 
            ...
            : vlTOPp->mips_cpu__DOT__register_file_output_A_decode);
    vlTOPp->mips_cpu__DOT__register_file_output_B_resolved_decode 
        = ((((0U != (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                              >> 0x10U))) & ((0x1fU 
                                              & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                 >> 0x10U)) 
    ...
    vlTOPp->mips_cpu__DOT__equal_decode = (vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode 
                                           == vlTOPp->mips_cpu__DOT__register_file_output_B_resolved_decode);
    if ((0x80000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
        vlTOPp->mips_cpu__DOT__equal_decode = 0U;
    } else {
        if ((0x40000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
            vlTOPp->mips_cpu__DOT__equal_decode = 0U;
        } else {
            if ((0x20000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
                vlTOPp->mips_cpu__DOT__equal_decode = 0U;
            } else {
                if ((0x10000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
                    vlTOPp->mips_cpu__DOT__equal_decode 
                        = ((0x8000000U & vlTOPp->mips_cpu__DOT__instruction_decode)
                            ? ((0x4000000U & vlTOPp->mips_cpu__DOT__instruction_decode)
                                ? VL_LTS_III(1,32,32, 0U, vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode)
                                : VL_GTES_III(1,32,32, 0U, vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode))
                            : ((0x4000000U & vlTOPp->mips_cpu__DOT__instruction_decode)
                                ? (vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode 
                                   != vlTOPp->mips_cpu__DOT__register_file_output_B_resolved_decode)
                                : (vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode 
                    ...
                    if ((0x8000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
                        vlTOPp->mips_cpu__DOT__equal_decode = 0U;
                    } else {
                        if ((0x4000000U & vlTOPp->mips_cpu__DOT__instruction_decode)) {
                            if (((1U == (0x1fU & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                  >> 0x10U))) 
                                 | (0x11U == (0x1fU 
                                              & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                 >> 0x10U))))) {
                                vlTOPp->mips_cpu__DOT__equal_decode 
                                    = VL_LTES_III(1,32,32, 0U, vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode);
                            } else {
                                if (((0U == (0x1fU 
                                             & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                >> 0x10U))) 
                                     | (0x10U == (0x1fU 
                                                  & (vlTOPp->mips_cpu__DOT__instruction_decode 
                                                     >> 0x10U))))) {
                                    vlTOPp->mips_cpu__DOT__equal_decode 
                                        = VL_GTS_III(1,32,32, 0U, vlTOPp->mips_cpu__DOT__register_file_output_A_resolved_decode);
                                }
                            }
                        } else {
                            vlTOPp->mips_cpu__DOT__equal_decode = 0U;
    ...
    vlTOPp->mips_cpu__DOT__program_counter_source_decode 
        = ((IData)(vlTOPp->mips_cpu__DOT__branch_decode) 
           & (IData)(vlTOPp->mips_cpu__DOT__equal_decode));
...
VL_INLINE_OPT void MIPS_Harvard_TB::_sequent__TOP__3(MIPS_Harvard_TB__Syms* __restrict vlSymsp) {
    ...
    MIPS_Harvard_TB* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->mips_cpu__DOT__write_data_memory = ((IData)(vlTOPp->reset)
                                                 ? 0U
                                                 : vlTOPp->mips_cpu__DOT__write_data_execute);
    vlTOPp->mips_cpu__DOT__sign_imm_execute = (((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
                                                ...
                                                ? 0U
                                                : vlTOPp->mips_cpu__DOT__sign_imm_decode);
    vlTOPp->mips_cpu__DOT__memory_write_memory = ((~ (IData)(vlTOPp->reset)) 
                                                  & (IData)(vlTOPp->mips_cpu__DOT__memory_write_execute));
    vlTOPp->mips_cpu__DOT__ALU_function_execute = (
                                                   ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
                                                    | (IData)(vlTOPp->reset))
                                                    ? 0U
                                                    : (IData)(vlTOPp->mips_cpu__DOT__ALU_function_decode));
    vlTOPp->mips_cpu__DOT__ALU_src_B_execute = ((~ 
                                                 ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
                                                  | (IData)(vlTOPp->reset))) 
                                                & (IData)(vlTOPp->mips_cpu__DOT__ALU_src_B_decode));
    vlTOPp->mips_cpu__DOT__register_destination_execute 
        = ((~ ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
               | (IData)(vlTOPp->reset))) & (IData)(vlTOPp->mips_cpu__DOT__register_destination_decode));
    vlTOPp->mips_cpu__DOT__register_file_output_A_execute 
        = (((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
            | (IData)(vlTOPp->reset)) ? 0U : vlTOPp->mips_cpu__DOT__register_file_output_A_decode);
    if (vlTOPp->reset) {
        vlTOPp->mips_cpu__DOT__program_counter_plus_four_decode = 0U;
    } else {
    ...
    vlTOPp->mips_cpu__DOT__register_file_output_B_execute 
        = (((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
            | (IData)(vlTOPp->reset)) ? 0U : vlTOPp->mips_cpu__DOT__register_file_output_B_decode);
    ...
    if (vlTOPp->reset) {
        vlTOPp->mips_cpu__DOT__program_counter_fetch = 0xbfc00000U;
    }
    ...
    vlTOPp->mips_cpu__DOT__memory_to_register_memory 
        = ((~ (IData)(vlTOPp->reset)) & (IData)(vlTOPp->mips_cpu__DOT__memory_to_register_execute));
    vlTOPp->mips_cpu__DOT__ALU_output_memory = ((IData)(vlTOPp->reset)
                                                 ? 0U
                                                 : vlTOPp->mips_cpu__DOT__ALU_output_execute);
    if (vlTOPp->reset) {
        vlTOPp->mips_cpu__DOT__instruction_decode = 0U;
    } else {
        if ((1U & (~ (IData)(vlTOPp->mips_cpu__DOT__stall_decode)))) {
            vlTOPp->mips_cpu__DOT__instruction_decode 
                = ((IData)(vlTOPp->mips_cpu__DOT__flush_fetch_decode_register)
    ...
    vlTOPp->mips_cpu__DOT__memory_to_register_execute 
        = ((~ ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
               | (IData)(vlTOPp->reset))) & (IData)(vlTOPp->mips_cpu__DOT__memory_to_register_decode));
    vlTOPp->data_address = vlTOPp->mips_cpu__DOT__ALU_output_memory;
    vlTOPp->mips_cpu__DOT__sign_imm_decode = ((0xffff0000U 
                                               & (VL_NEGATE_I((IData)(
                                                                      (1U 
                                              ...
                                              | (0xffffU 
                                                 & vlTOPp->mips_cpu__DOT__instruction_decode));
    vlTOPp->mips_cpu__DOT__program_counter_multiplexer_jump_memory 
        = ((~ (IData)(vlTOPp->reset)) & (IData)(vlTOPp->mips_cpu__DOT__program_counter_multiplexer_jump_execute));
    vlTOPp->mips_cpu__DOT__program_counter_multiplexer_jump_execute 
        = ((~ ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
               | (IData)(vlTOPp->reset))) & (IData)(vlTOPp->mips_cpu__DOT__program_counter_multiplexer_jump_decode));
}
...
VL_INLINE_OPT void MIPS_Harvard_TB::_sequent__TOP__5(MIPS_Harvard_TB__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->mips_cpu__DOT__ALU_LO_output_memory = ((IData)(vlTOPp->reset)
                                                    ? 0U
                                                    : vlTOPp->mips_cpu__DOT__ALU_LO_output_execute);
    vlTOPp->mips_cpu__DOT__ALU_HI_output_memory = ((IData)(vlTOPp->reset)
                                                    ? 0U
                                                    : vlTOPp->mips_cpu__DOT__ALU_HI_output_execute);
    vlTOPp->mips_cpu__DOT__hi_lo_register_write_memory 
        = ((~ (IData)(vlTOPp->reset)) & (IData)(vlTOPp->mips_cpu__DOT__hi_lo_register_write_execute));
    vlTOPp->mips_cpu__DOT__write_register_memory = 
        ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->mips_cpu__DOT__write_register_execute));
    vlTOPp->mips_cpu__DOT__register_write_memory = 
        ((~ (IData)(vlTOPp->reset)) & (IData)(vlTOPp->mips_cpu__DOT__register_write_execute));
    vlTOPp->mips_cpu__DOT__write_register_execute = 
        ((IData)(vlTOPp->mips_cpu__DOT__register_destination_execute)
          ? (IData)(vlTOPp->mips_cpu__DOT__Rd_execute)
          : (IData)(vlTOPp->mips_cpu__DOT__Rt_execute));
    vlTOPp->mips_cpu__DOT__hi_lo_register_write_execute 
        = ((~ ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
               | (IData)(vlTOPp->reset))) & (IData)(vlTOPp->mips_cpu__DOT__hi_lo_register_write_decode));
    vlTOPp->mips_cpu__DOT__register_write_execute = 
        ((~ ((IData)(vlTOPp->mips_cpu__DOT__flush_execute_register) 
             | (IData)(vlTOPp->reset))) & (IData)(vlTOPp->mips_cpu__DOT__register_write_decode));
    vlTOPp->mips_cpu__DOT__forward_A_execute = ((((0U 
                                                   != (IData)(vlTOPp->mips_cpu__DOT__Rs_execute)) 
                                                  & ((IData)(vlTOPp->mips_cpu__DOT__Rs_execute) 
                                                     == (IData)(vlTOPp->mips_cpu__DOT__write_register_memory))) 
...
void MIPS_Harvard_TB::_ctor_var_reset() {
    ...
    mips_cpu__DOT__equal_decode = VL_RAND_RESET_I(1);
    ...
    mips_cpu__DOT__register_file_output_A_resolved_decode = VL_RAND_RESET_I(32);
    mips_cpu__DOT__register_file_output_B_resolved_decode = VL_RAND_RESET_I(32);
