...
VL_MODULE(MIPS_Harvard_TB) {
  public:
    ...
    struct {
        CData/*0:0*/ mips_cpu__DOT__internal_clk;
        CData/*0:0*/ mips_cpu__DOT__HI_LO_output;
        CData/*0:0*/ mips_cpu__DOT__program_counter_source_decode;
        CData/*0:0*/ mips_cpu__DOT__register_write_decode;
        CData/*0:0*/ mips_cpu__DOT__memory_to_register_decode;
        CData/*0:0*/ mips_cpu__DOT__memory_write_decode;
        CData/*0:0*/ mips_cpu__DOT__ALU_src_B_decode;
        ...
        CData/*4:0*/ mips_cpu__DOT__write_register_execute;
        CData/*0:0*/ mips_cpu__DOT__ALU_src_B_execute;
        ...
        CData/*0:0*/ mips_cpu__DOT__register_write_memory;
        CData/*4:0*/ mips_cpu__DOT__write_register_memory;
        ...
        IData/*31:0*/ mips_cpu__DOT__source_A_ALU_execute;
        IData/*31:0*/ mips_cpu__DOT__source_B_ALU_execute;
        IData/*31:0*/ mips_cpu__DOT__write_data_execute;
    ...
    struct {
        ...
        QData/*63:0*/ mips_cpu__DOT__alu__DOT__ALU_HI_LO_output;
        IData/*31:0*/ mips_cpu__DOT__register_file__DOT__registers[32];
    };
