...
VL_MODULE(MIPS_Harvard_TB) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__HI_LO_output;
        CData/*0:0*/ mips_cpu_harvard__DOT__program_counter_source_decode;
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__ALU_src_B_decode;
        CData/*0:0*/ mips_cpu_harvard__DOT__register_destination_decode;
        CData/*0:0*/ mips_cpu_harvard__DOT__branch_decode;
        CData/*0:0*/ mips_cpu_harvard__DOT__hi_lo_register_write_decode;
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__register_destination_execute;
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__ALU_src_B_execute;
        CData/*5:0*/ mips_cpu_harvard__DOT__ALU_function_execute;
        CData/*0:0*/ mips_cpu_harvard__DOT__hi_lo_register_write_execute;
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__hi_lo_register_write_memory;
        ...
        CData/*0:0*/ mips_cpu_harvard__DOT__hi_lo_register_write_writeback;
        CData/*0:0*/ mips_cpu_harvard__DOT__memory_to_register_writeback;
        CData/*0:0*/ mips_cpu_harvard__DOT__program_counter_multiplexer_jump_writeback;
        ...
        CData/*1:0*/ mips_cpu_harvard__DOT__forward_A_execute;
        CData/*1:0*/ mips_cpu_harvard__DOT__forward_B_execute;
        ...
        IData/*31:0*/ mips_cpu_harvard__DOT__register_file_output_A_resolved_decode;
        IData/*31:0*/ mips_cpu_harvard__DOT__register_file_output_B_resolved_decode;
        IData/*31:0*/ mips_cpu_harvard__DOT__sign_imm_decode;
        IData/*31:0*/ mips_cpu_harvard__DOT__register_file_output_A_execute;
        IData/*31:0*/ mips_cpu_harvard__DOT__register_file_output_B_execute;
        IData/*31:0*/ mips_cpu_harvard__DOT__source_A_ALU_execute;
        IData/*31:0*/ mips_cpu_harvard__DOT__source_B_ALU_execute;
